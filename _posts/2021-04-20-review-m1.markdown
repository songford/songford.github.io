...
I've heard good things about the battery life of MacBooks with Apple Silicon. It is indeed quite good. Two hours of what I'd consider heavy usage (building docker images, compressing videos) drains about 20% battery. Therefore, with a bit of linear interpolation, one can assume a full recharge should at least give you about 10 hours of battery life. I didn't do quantitive comparison with my work MacBook Pro, but my gut feeling is two hours of such usage will leave me with around 20% battery remaining on that thing. Granted, to be fair, I would expect time has taken toil on its stamina, but still, the contrast is just too stark. Again, if you aren't satisfied with the stamina of MacBook Air, feel free to chip in a bit more for MacBook Pro, which has larger batteries. 
...
Not quite. As a matter of fact, `Rosetta` is still needed, since 
...
the release team only builds for `linux/amd64`. That's why docker on M1 complains when you ask it to run `mysql:latest`. It can't find a build for `arm64`! 

Does that mean we are out of luck with `mysql`? Not really.
...
I am satisfied with my purchase so far, but your mileage might vary. Very few softwares released by 3rd-party companies as of now have built for Apple Silicon natively, but Rosetta 2 yields acceptable performance at least to my standard. With years go by, more software providers will jump on this bandwagon, and with the performance, thermal control and battery life of an ARM-based processor, I am optimistic to the future of Apple Silicon-based Macs. 
